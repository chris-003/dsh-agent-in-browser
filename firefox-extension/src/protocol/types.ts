...
// interfaces are for type checking. This is the Firefox copy; it mirrors
// `chrome-extension/src/protocol/types.ts`.
...
export interface ScreenshotResult {
  ...
  width: number
  height: number
  /** Optional human-readable note, e.g. a full-page screenshot that Firefox
   *  cannot capture natively and was degraded to a visible-area capture. */
  note?: string
}
